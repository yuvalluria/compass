...
```json
{
  ...
  "hardware": "H100"                     // Optional - only if GPU mentioned
}
```
...
| 4 | With Hardware | "translation on A100 GPU" | hardware field extracted |
| 5 | Full | "RAG for 500 users, low latency, H100" | priority + hardware extracted |
